...
df_15 = pd.DataFrame(columns=["Identificador", "Nome Competição", "Regata", "Nome Competidor", "Pontuação Regata (Nha)", "Classe Vela", "Flag Name", "Posição Geral"], data=merge("scraping_2024/cleaned_data/470_mixed.csv", 7, 17, 5, "470", 2, competition_name="World Championship 2024"))
df_16 = pd.DataFrame(columns=["Identificador", "Nome Competição", "Regata", "Nome Competidor", "Pontuação Regata (Nha)", "Classe Vela", "Flag Name", "Posição Geral"], data=merge("scraping_2024/cleaned_data/49er_wc.csv", 6, 23, 4, "49er", 2, competition_name="World Championship 2024"))
df_17 = pd.DataFrame(columns=["Identificador", "Nome Competição", "Regata", "Nome Competidor", "Pontuação Regata (Nha)", "Classe Vela", "Flag Name", "Posição Geral"], data=merge("scraping_2024/cleaned_data/49erfx_wc.csv", 6, 22, 4, "49erfx", 2, competition_name="World Championship 2024"))
